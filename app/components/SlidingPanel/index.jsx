...
const SlidingPanelView = (props) => (
  <View style={{ height: 200, width, backgroundColor: "blue" }}>
    <Text style={{ color: "white" }}>Hello world</Text>
  </View>
);
...
export default class SlidingPanel extends Component {
  ...
  componentWillMount() {
    ...
    this.state.panResponder = PanResponder.create({
      ...
      onPanResponderRelease: (e, gesture) => {
        ...
        this.props.setPanelPosition(sliderPosition);
        if (a !== 0) {
          this.props.onDragStop(e, gesture, sliderPosition);
        }
  ...
  render() {
    ...
    //   this.state.heightAnim.setValue(height - this.props.headerLayoutHeight);
    // }
    return (
      <View
        style={
...
SlidingPanel.propTypes = {
  ...
  onDragStop: (event, gestureState, sliderPosition) => {},
